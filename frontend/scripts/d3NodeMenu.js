...
const nodeMenuGenerator =
{
    ...
    "group":[generateNodeMenu_compareChildren,generateNodeMenu_addGroupNode,generateNodeMenu_addSubNode,generateNodeMenu_editDetails,generateNodeMenu_removeNode],
